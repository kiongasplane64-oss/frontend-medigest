...
// Classes CSS pour les variantes de bouton (version simplifiée pour le calendrier)
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          calendarButtonClasses.outline,
          calendarButtonClasses.icon,
