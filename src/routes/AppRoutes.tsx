...
import { PrivateRoute, PublicRoute } from '@/components/auth/AuthGuards';
...
/**
 * Composant temporaire pour les modules en cours de développement
 */
    ...
    <Routes>
      ...
      <Route element={<PrivateRoute />}>
        <Route element={<Sidebar />}> 
          ...
          {/* Opérations - Alignés avec les href de la Sidebar */}
